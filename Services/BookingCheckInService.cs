using ConferenceRoomBooking.DTOs.BookingCheckIn;
...
namespace ConferenceRoomBooking.Services
{
    public class BookingCheckInService : IBookingCheckInService
    {
        ...
        public async Task<BookingCheckInResponseDto> CheckInAsync(int bookingId, int userId)
        {
            ...
            if (booking.SessionStatus != SessionStatus.Reserved)
                throw new InvalidOperationException("Booking is not in reserved status");
        ...
        public async Task<BookingCheckInResponseDto> CheckOutAsync(int bookingId, int userId)
        {
            ...
            if (booking.SessionStatus != SessionStatus.CheckedIn)
...
Enjoy your meeting!";
            ...
            await _notificationService.SendNotificationAsync(new DTOs.UserNotification.SendNotificationDto
            {
                ...
                Title = subject,
                Message = body,
                Type = Enum.NotificationType.CheckIn
            });
        }
...
Thank you for using our booking system!";
            ...
            await _notificationService.SendNotificationAsync(new DTOs.UserNotification.SendNotificationDto
            {
                ...
                Title = subject,
                Message = body,
                Type = Enum.NotificationType.CheckOut
            });
        }
