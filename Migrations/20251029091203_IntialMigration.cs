            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RSVPId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EventId = table.Column<int>(type: "int", nullable: false),
                    InterestedUserIds = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NotInterestedUserIds = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MaybeUserIds = table.Column<string>(type: "nvarchar(max)", nullable: false),
